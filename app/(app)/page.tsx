...
const MENUS = [
  {
    ...
    icon: '🗺',
    title: '전술 맵보드',
    desc: '경로·화살표·스티커로 작전을 그리고 팀원을 맵에 드래그로 배치하세요. URL 공유로 함께 볼 수 있습니다.',
    badge: null,
    accent: '#6c63ff',
    glow: 'rgba(108,99,255,0.15)',
    border: 'rgba(108,99,255,0.3)',
    tags: ['맵 드로잉', '팀원 배치', 'URL 공유'],
  },
  {
    href: '/community',
    icon: '💬',
    title: '클랜 커뮤니티',
    desc: '공지사항과 경기 결과를 팀원들과 나누는 클랜 소통 공간입니다.',
    badge: '글 6개',
    accent: '#40b870',
  ...
  },
  {
    ...
    icon: '📅',
    title: '클랜 캘린더',
    desc: '팀원들이 직접 게임 가능 시간을 체크하면 겹치는 시간대를 바로 확인할 수 있습니다.',
    badge: null,
    accent: '#e05050',
  ...
  },
  {
    ...
    icon: '🤖',
    title: 'AI 전술 피드백',
    desc: '전장 리플레이 파일을 업로드하거나 경기 상황을 입력하면 AI가 전술 개선점을 분석해드립니다.',
    badge: 'NEW',
    accent: '#4090e0',
  ...
  },
  {
    ...
    icon: '👥',
    title: '멤버 관리',
    desc: '클랜원 역할을 설정하고 활동 현황을 관리하세요. 초대 링크로 새 멤버를 영입할 수 있습니다.',
    badge: '5명',
    accent: '#e8a020',
